...
# Commit
git commit -m "Initial release: JobFlow Plugin v1.0.0"

# Add remote (use YOUR GitHub URL)
git remote add origin https://github.com/duncanapm/jobflow.git
...
2. **Choose tag**: v1.0.0
3. **Release title**: "JobFlow Plugin v1.0.0"
4. **Description**:
   ```markdown
   ## 🎉 Initial Release
...
```json
{
  "id": "duncanapm/jobflow",
  "name": "JobFlow",
  "description": "Complete job search workflow management",
  "author": "Duncan",
  "category": "productivity",
  "tags": ["job-search", "career", "resume"],
  "repository": "https://github.com/duncanapm/jobflow",
  "install": "claude plugin install duncanapm/jobflow"
}
```
...
3. **Test installation**: `claude plugin install duncanapm/jobflow`
