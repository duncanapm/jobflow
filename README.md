...
1. **Download** [jobflow.zip](https://github.com/duncanapm/jobflow/releases/latest/download/jobflow.zip)
...
3. **Start using:**
   ```
   Help me organize my job search
   ```

That's it! JobFlow is ready to use.
